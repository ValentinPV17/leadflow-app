                  ...
                  body: JSON.stringify({
                            ...
                            messages: [{
                                        ...
                                        content: [
                                          {
                                                          type: 'text',
                                                          text: 'Analiza este documento PDF y extrae el Ideal Customer Profile (ICP). Responde SOLO con un JSON valido, sin texto adicional, sin backticks: {"industries":["industria1"],"titles":["cargo1"],"country":"Chile","employeesMin":50,"seniorities":["director","manager"]}. Industrias y cargos en ingles para Apollo. Seniorities validos: c_suite, vp, director, head, manager, senior, entry.'
                                          },
                                          {
                                                          type: 'image_url',
                                                          image_url: {
